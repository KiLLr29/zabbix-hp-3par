...
def main():
    ...
    class_description = get_class_description(wbem_conn, "TPD_FCPort")
    instances = get_instances_of_class(wbem_conn, "TPD_FCPort")
    
    # Выводим свойства класса
    print(f"Properties of TPD_FCPort:")
    ...
    for instance in instances:
        print(f"Instance of TPD_FCPort:")
